...
function insData() {
  ...
  else if (quantity1 == "" || (!quantity1.includes("Kg") && !quantity1.includes("Dozen"))) {
...
async function myedit(id){
    ...
    <form action="" class="form" onsubmit="return finalupdate('${d.id}')">
                    ...
                    <label for="fname0">FruitName</label>
...
function finalupdate(id){
    ...
    if (fname2 == "") {
      ...
      else if (quantity2 == "" || (!quantity2.includes("Kg") && !quantity2.includes("Dozen"))) {
        alert("Please enter Quantity in Kg/Dozen");
